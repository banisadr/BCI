...
%% 
% <latex>
% \subsection*{2.5 DANGER ZONE}
% One danger of using K-means comes from the fact that K-means is very
% sensitive to initial conditions. For instance, while running K-medians, I
% was able to get an incorrect split in the data where the top half of each 
% cluster was red and the bottom half was green. A second issue with K-means
% is that it does not provide as much information as alternative
% unsupervised clustering algorithms such as Gaussian Mixture Models. GMM's
% give the user statistics such as the variance within a cluster along each 
% principle axis as part of the computatoin. A third danger of using 
% K-means as an unsupervised learning technique is that the programmer must 
